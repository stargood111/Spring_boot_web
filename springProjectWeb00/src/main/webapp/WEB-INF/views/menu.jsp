...
<tr>
	...
	<td class = "td-type06"><img src="/resources/img/caramel.jpg"><br>카라멜마끼아또(ICE)<br><br>
	  ...
	  <input type = "text" id = "name3" value = "콜드브루(ICE)" hidden = "true">
...
<tr>
	...
	<td class = "td-type06"><img src="/resources/img/coldlatte.jpg"><br>콜드브루라떼(ICE)<br>
	  ...
	  <input type = "text" id = "name5" value = "콜드브루(ICE)" hidden = "true">
...
<hr>
   <form action = "OrderOk" align = "center">
      <input type="text" name="order1" id="result1" value="" size="10">
      수량<input type="text" name="order1num" id="resultNum1" value="" size="10">
    	가격<input type = "text" name = order1price id ="resultPrice1" value= "" size ="10">원
    <br>
    
      <input type="text" name="order2" id="result2" value="" size = "10">
       수량<input type="text" name="order2num" id="resultNum2" value="" size="10">
    	가격<input type = "text" name = order2price id ="resultPrice2" value= "" size ="10">원
	<br>
    	
      <input type="text" name="order3" id="result3" value="" size = "10">
      수량<input type="text" name="order3num" id="resultNum3" value="" size="10">
      가격<input type = "text" name = order3price id ="resultPrice3" value= "" size ="10">원
  	<br>
   <input type="text" name="order4" id="result4" value="" size="10">
      수량<input type="text" name="order4num" id="resultNum4" value="" size="10">
    	가격<input type = "text" name = order4price id ="resultPrice4" value= "" size ="10">원
    <br>
    
      <input type="text" name="order5" id="result5" value="" size = "10">
       수량<input type="text" name="order5num" id="resultNum5" value="" size="10">
    	가격<input type = "text" name = order5price id ="resultPrice5" value= "" size ="10">원
	<br>
    	
      <input type="text" name="order6" id="result6" value="" size = "10">
      수량<input type="text" name="order6num" id="resultNum6" value="" size="10">
      가격<input type = "text" name = order6price id ="resultPrice6" value= "" size ="10">원
  	<br>
